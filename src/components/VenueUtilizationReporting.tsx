  ...
  return (
    <div className="w-full rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] p-5 sm:p-7 shadow-xs">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-5 pb-2">
        <div className="p-4 rounded-xl border border-[var(--color-border)] bg-[var(--color-panel-subtle)] space-y-1 shadow-xs">
          ...
          <div className="text-2xl sm:text-3xl font-semibold font-mono text-[var(--color-text-primary)]">
        ...
        <div className="p-4 rounded-xl border border-[var(--color-border)] bg-[var(--color-panel-subtle)] space-y-1 shadow-xs">
          ...
          <div className="text-2xl sm:text-3xl font-semibold font-mono text-indigo-600 dark:text-indigo-400">
      ...
      {/* Chart & Live Event Feed - items-stretch for vertical parity */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 pt-4 items-stretch">
        {/* Left Chart (7 cols) - flex flex-col justify-between to match right column */}
        <div className="lg:col-span-7 rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] p-4 sm:p-5 flex flex-col justify-between shadow-xs">
          ...
          {/* Left Chart Telemetry Footer - matches right column bottom height */}
          <div className="mt-4 pt-3.5 border-t border-[var(--color-border)] flex flex-col sm:flex-row sm:items-center justify-between gap-2 text-xs font-mono text-[var(--color-text-secondary)]">
            <div className="flex items-center gap-2">
              <span className="flex items-center gap-1.5 text-emerald-700 dark:text-emerald-400 font-medium">
                <CheckCircle2 className="h-3.5 w-3.5 text-emerald-600 shrink-0" />
                RevPASH Peak: $194.50/hr
              </span>
              <span className="text-[var(--color-text-muted)]">•</span>
              <span className="text-[var(--color-text-primary)] font-medium">96.2% Lane Capacity</span>
            </div>
            <span className="text-indigo-600 dark:text-indigo-400 font-medium">Auto-Priced via Dynamic Rules</span>
          </div>
        </div>

        {/* Right POS Activity Stream (5 cols) - flex flex-col justify-between */}
        <div className="lg:col-span-5 rounded-xl border border-[var(--color-border)] bg-[var(--color-panel-subtle)] p-4 sm:p-5 flex flex-col justify-between shadow-xs">
          <div>
            <div className="flex items-center justify-between border-b border-[var(--color-border)] pb-2.5 mb-3">
              <span className="text-xs font-semibold text-[var(--color-text-primary)] uppercase tracking-wider font-mono flex items-center gap-1.5">
              ...
              {RECENT_ORDERS.map((ord) => (
                ...
                >
                  ...
                  <div className="text-right shrink-0">
                    ...
                    <Badge variant="outline" className="text-xs px-1.5 py-0 border-emerald-300 text-emerald-700 dark:text-emerald-300 bg-emerald-50 dark:bg-emerald-950/40 font-mono">
                      {ord.status}
                    </Badge>
                  </div>
                </div>
          ...
          <div className="p-3 rounded-lg bg-indigo-50/80 dark:bg-indigo-950/40 border border-indigo-200 dark:border-indigo-800 text-xs font-mono text-indigo-900 dark:text-indigo-200 mt-4 leading-relaxed">
            <span className="font-semibold">POS Reconciliation: </span>
